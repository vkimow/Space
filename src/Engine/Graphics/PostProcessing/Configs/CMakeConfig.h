...
namespace Engine::Graphics::Configs
{
    ...
    const std::string KERNEL_FRAG_RELATIVE_PATH = "Shaders/PostProcessing/kernel.frag";
    ...
    const std::string KERNEL_VERT_RELATIVE_PATH = "Shaders/PostProcessing/kernel.vert";
