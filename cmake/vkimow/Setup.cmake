...
macro(setup_vkimow_global_directories)
    ...
    set(${PREFIX}_EXTERNAL_DIR   "${ROOT_DIR}/external"                         CACHE INTERNAL "")
    ...
    set(${PREFIX}_LIB_DIR        "${ROOT_DIR}/lib"                              CACHE INTERNAL "")
    set(${PREFIX}_LIB_CONFIG_DIR "${ROOT_DIR}/lib/${${PREFIX}_CONFIG_STRING}"   CACHE INTERNAL "")

    message("Root Dir:              ${${PREFIX}_ROOT_DIR}")
    message("Include Dir:           ${${PREFIX}_INCLUDE_DIR}")
    message("Source Dir:            ${${PREFIX}_SOURCE_DIR}")
    message("External Dir:          ${${PREFIX}_EXTERNAL_DIR}")
